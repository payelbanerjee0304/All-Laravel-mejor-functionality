    <x-layout>
        ...
        <form id="registrationForm">
            ...
            <div class="form-group" id="districtdiv" hidden>
            ...
            <div class="form-group" id="citydiv" hidden>
            ...
            <div class="form-group">
                ...
                <label class="btn btn-secondary">
                    <input type="radio" id="gender_male" name="gender" class="gender" autocomplete="off" value="Male">Male
                    </label>
                    <label class="btn btn-secondary">
                    <input type="radio" id="gender_female" name="gender" class="gender" autocomplete="off" value="Female">Female
                    </label>
                    <label class="btn btn-secondary">
                    <input type="radio" id="gender_others" name="gender" class="gender" autocomplete="off" value="Others">Others
                </label><br>
                <small id="gender_error"></small>
            </div>
            <div class="form-group">
                <label for="">Language:</label>
                <input type="checkbox" name="language[]" class="language" id="language" class="language button btn-secondary" value="English">English
                <input type="checkbox" name="language[]" class="language" id="language" class="language button btn-secondary" value="Hindi">Hindi
                <input type="checkbox" name="language[]" class="language" id="language" class="language button btn-secondary" value="Bengali">Bengali
                <br>
