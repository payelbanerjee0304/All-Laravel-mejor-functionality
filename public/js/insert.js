$(document).ready(function () {
    ...
    function validatePassword() {
        ...
        if (password === "") {
            ...
            $("#password_error")
                .text("Password must have 8 charecter")
                .css("color", "red");
        } else {
            $("#password_error").text("");
            return true;
            ...
            $.ajax({
                ...
                success: function (districts) {
                    ...
                    if (districts.length > 0) {
                        ...
                        $("#city")
                            .empty()
                            .append('<option value="">Select</option>'); // Clear city dropdown
    ...
    function validateProfilePicture() {
        ...
        if (image === "") {
            $("#profile_picture_error")
                .text("Profile Picture Field is Required")
                .css("color", "red");
            return false;
        } else {
    ...
    $("#crop_button").click(function () {
        cropper.getCroppedCanvas().toBlob((blob) => {
            ...
            reader.onloadend = () => {
                ...
                $(
                    '#selected_images .image-container[data-index="' +
                        currentImageIndex +
                        '"] img'
                ).attr("src", base64data);
